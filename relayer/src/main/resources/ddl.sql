create database if not exists l2relayer;
use l2relayer;
...
(
    ...
    `batch_header_hash`       VARCHAR(66) BINARY  NOT NULL,
    `batch_index`             BIGINT UNSIGNED     NOT NULL,
    `l1_message_popped`       INT(11)             NOT NULL,
    `total_l1_message_popped` INT(11)             NOT NULL,
    `data_hash`               VARCHAR(66) BINARY  NOT NULL,
    `parent_batch_hash`       VARCHAR(66) BINARY  NOT NULL,
