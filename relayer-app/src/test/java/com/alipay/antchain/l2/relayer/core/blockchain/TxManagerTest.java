...
public class TxManagerTest extends TestBase {
    ...
    @Resource
    private INonceManager l1BlobNonceManager;
    ...
    public void testAcbRawTransactionManager() {
        ...
        AcbRawTransactionManager manager = new AcbRawTransactionManager(web3j, parentChainConfig.getL1BlobPoolTxSignService(), 123, redisson, ethForkBlobConfig,
                new RemoteNonceManager(parentChainConfig.getL1BlobPoolTxSignService().getAddress(), web3j));
    ...
    public void testAcbFastRawTransactionManager() {
        ...
        var manager = new AcbFastRawTransactionManager(web3j, parentChainConfig.getL1BlobPoolTxSignService(), 123, redisson, ethForkBlobConfig,
                new CachedNonceManager(redisson, web3j, 123, parentChainConfig.getL1BlobPoolTxSignService().getAddress(), ChainTypeEnum.LAYER_ONE, rollupRepository, NonceResetChecker.ETHEREUM_GETH));
        manager.setTxHashVerifier(txHashVerifier);

        // Clear any existing nonce
        redisson.getAtomicLong(manager.getNonceManager().getEthNonceValKey(123, parentChainConfig.getL1BlobPoolTxSignService().getAddress())).delete();
        ...
        Assert.assertEquals(1, redisson.getAtomicLong(manager.getNonceManager().getEthNonceValKey(123, parentChainConfig.getL1BlobPoolTxSignService().getAddress())).get());
        ...
        Assert.assertEquals(2, redisson.getAtomicLong(manager.getNonceManager().getEthNonceValKey(123, parentChainConfig.getL1BlobPoolTxSignService().getAddress())).get());
        ...
        when(rollupRepository.queryLatestNonce(notNull(), notNull())).thenReturn(BigInteger.valueOf(2359));
        resultBlob = manager.sendTx(ListUtil.toList(new Blob(Numeric.hexStringToByteArray(A_BLOB))),
                new Eip4844GasPrice(BigInteger.ONE, BigInteger.ONE, BigInteger.ONE, BigInteger.ONE), BigInteger.ONE, "0x26E4259c4f391D9a7EFDe9b0A871b0509cD143D4", BigInteger.ZERO, "");

        Assert.assertTrue(redisson.getAtomicLong(manager.getNonceManager().getEthNonceValKey(123, parentChainConfig.getL1BlobPoolTxSignService().getAddress())).isExists());
        Assert.assertEquals(2, redisson.getAtomicLong(manager.getNonceManager().getEthNonceValKey(123, parentChainConfig.getL1BlobPoolTxSignService().getAddress())).get());
        ...
        Assert.assertFalse(redisson.getAtomicLong(manager.getNonceManager().getEthNonceValKey(123, parentChainConfig.getL1BlobPoolTxSignService().getAddress())).isExists());
    ...
    public void testAcbFastRawTransactionManager_NonceRecovery() {
        ...
        Assert.assertEquals(4, redisson.getAtomicLong(manager.getNonceManager().getEthNonceValKey(123, parentChainConfig.getL1BlobPoolTxSignService().getAddress())).get());
        ...
        Assert.assertEquals(5, redisson.getAtomicLong(manager.getNonceManager().getEthNonceValKey(123, parentChainConfig.getL1BlobPoolTxSignService().getAddress())).get());
    }
    ...
    public void testAcbFastRawTransactionManager_NonceConflict() {
        ...
        when(rollupRepository.queryLatestNonce(notNull(), notNull())).thenReturn(BigInteger.valueOf(10));
        ...
        Assert.assertEquals(9, redisson.getAtomicLong(manager.getNonceManager().getEthNonceValKey(123, parentChainConfig.getL1BlobPoolTxSignService().getAddress())).get());

        when(rollupRepository.queryLatestNonce(notNull(), notNull())).thenReturn(BigInteger.valueOf(9));
        result = manager.sendTx(
                new Eip1559GasPrice(BigInteger.ONE, BigInteger.ONE, BigInteger.ONE),
                BigInteger.ONE,
                "0x26E4259c4f391D9a7EFDe9b0A871b0509cD143D4",
    ...
    public void testAcbFastRawTransactionManager_BlobTxNetworkFailure() {
        ...
        Assert.assertEquals(0, redisson.getAtomicLong(manager.getNonceManager().getEthNonceValKey(123, parentChainConfig.getL1BlobPoolTxSignService().getAddress())).get());
    }
