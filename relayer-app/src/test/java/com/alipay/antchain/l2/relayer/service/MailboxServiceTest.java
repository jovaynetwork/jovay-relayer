...
public class MailboxServiceTest extends TestBase {
    ...
    public void testProcessL1MsgBatch_L2ClientException() {
        when(l2Client.queryL2MailboxPendingNonce()).thenThrow(new RuntimeException("L2 client connection failed"));
    ...
    public void testProcessL1MsgBatch_MessageNotFound() {
        when(l2Client.queryL2MailboxPendingNonce()).thenReturn(BigInteger.ONE);
        when(l2Client.queryL2MailboxLatestNonce()).thenReturn(BigInteger.ZERO);
