...
public class EtherscanGasPriceProvider extends ApiGasPriceProvider {
    ...
    public IGasPrice getEip1559GasPrice() {
        return new Eip1559GasPrice(getBaseFee().multiply(BigInteger.valueOf(2)), getMaxPriorityFeePerGas(), getBaseFee());
    }

    @Override
    public IGasPrice getEip4844GasPrice() {
        return new Eip4844GasPrice(getBaseFee().multiply(BigInteger.valueOf(2)), getMaxPriorityFeePerGas(), getMaxFeePerBlobGas(), getBaseFee());
    }
}
