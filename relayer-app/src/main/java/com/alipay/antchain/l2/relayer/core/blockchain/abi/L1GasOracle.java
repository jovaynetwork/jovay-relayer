...
public class L1GasOracle extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> getTxL1Fee(BigInteger txLength) {
        final Function function = new Function(
                FUNC_GETTXL1FEE, 
    ...
    public static RemoteCall<L1GasOracle> deploy(Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return deployRemoteCall(L1GasOracle.class, web3j, credentials, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<L1GasOracle> deploy(Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(L1GasOracle.class, web3j, credentials, gasPrice, gasLimit, getDeploymentBinary(), "");
    }

    public static RemoteCall<L1GasOracle> deploy(Web3j web3j, TransactionManager transactionManager,
            ContractGasProvider contractGasProvider) {
        return deployRemoteCall(L1GasOracle.class, web3j, transactionManager, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<L1GasOracle> deploy(Web3j web3j, TransactionManager transactionManager,
            BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(L1GasOracle.class, web3j, transactionManager, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
