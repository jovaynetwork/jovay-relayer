...
public class BlockchainConfig {
    ...
    public BaseRawTransactionManager l1BlobPoolTxTransactionManager(
        ...
        return createTransactionManager(chainId, l1NoncePolicy, l1Web3j, Objects.requireNonNull(l1BlobPoolTxSignService), redisson, ethBlobForkConfig);
    }
    ...
    public BaseRawTransactionManager l1LegacyPoolTxTransactionManager(
        ...
        return createTransactionManager(chainId, l1NoncePolicy, l1Web3j, Objects.requireNonNull(l1LegacyPoolTxSignService), redisson, ethBlobForkConfig);
    }
    ...
    public BaseRawTransactionManager l2TransactionManager(
        ...
        return createTransactionManager(chainId, l2NoncePolicy, l2Web3j, Objects.requireNonNull(l2TxSignService), redisson, null);
    }
    ...
    private BaseRawTransactionManager createTransactionManager(
                ...
                RedissonClient redisson, EthBlobForkConfig ethBlobForkConfig) {
        log.info("create tx manager by {}-{}", chainId, noncePolicy);
        return noncePolicy == EthNoncePolicyEnum.FAST ?
                new AcbFastRawTransactionManager(web3j, txSignService, chainId.longValue(), redisson, ethBlobForkConfig)
