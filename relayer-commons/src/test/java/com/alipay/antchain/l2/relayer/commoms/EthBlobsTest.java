...
public class EthBlobsTest {
    ...
    public void testExtractBlobsFromHeavyChunks() {
        ...
        var ethBlobs = BlobsDaData.buildFrom(BatchVersionEnum.BATCH_V1, new ChunksPayload(chunks));
        ...
        // batch v0
        ethBlobs = BlobsDaData.buildFrom(BatchVersionEnum.BATCH_V0, new ChunksPayload(chunks));
