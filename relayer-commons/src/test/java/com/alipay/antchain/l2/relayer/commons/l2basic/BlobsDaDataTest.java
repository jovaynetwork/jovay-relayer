...
public class BlobsDaDataTest {
    ...
    public void setUp() {
        ...
        testPayload = new ChunksPayload(BatchVersionEnum.BATCH_V1, testChunks);
    }
    ...
    public void testWithSingleChunk() {
        ...
        ChunksPayload payload = new ChunksPayload(BatchVersionEnum.BATCH_V1, singleChunk);
    ...
    public void testWithManyChunks() {
        ...
        ChunksPayload payload = new ChunksPayload(BatchVersionEnum.BATCH_V1, manyChunks);
    ...
    public void testCompressionEffectiveness() {
        ...
        ChunksPayload payload = new ChunksPayload(BatchVersionEnum.BATCH_V1, repetitiveChunks);
    ...
    public void testDataHashUniqueness() {
        ...
        BlobsDaData daData1 = BlobsDaData.buildFrom(BatchVersionEnum.BATCH_V0, new ChunksPayload(BatchVersionEnum.BATCH_V1, chunks1));
        BlobsDaData daData2 = BlobsDaData.buildFrom(BatchVersionEnum.BATCH_V0, new ChunksPayload(BatchVersionEnum.BATCH_V1, chunks2));
    ...
    public void testWithExtremelySmallPayload() {
        ...
        ChunksPayload payload = new ChunksPayload(BatchVersionEnum.BATCH_V1, smallChunks);
