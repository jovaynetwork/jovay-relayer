...
public class ChunkTest {
    ...
    public void testAllArgsConstructor() {
        ...
        Chunk c = new Chunk((byte) 3, testBlocks, testTx);
    ...
    public void testGetNumBlocksVal() {
        ...
        long numBlocks = chunk.getNumBlocks();

        assertEquals(5L, numBlocks);
    }
    ...
    public void testSerialize() {
        ...
        byte[] serialized = chunk.serialize(false);
    ...
    public void testDeserializeFrom() {
        ...
        byte[] serialized = chunk.serialize(false);
        Chunk deserialized = Chunk.deserializeFrom(serialized, false);

        assertNotNull(deserialized);
        assertEquals(chunk.getNumBlocks(), deserialized.getNumBlocks());
    ...
    public void testFromJson() {
        ...
        assertEquals(chunk.getNumBlocks(), fromJson.getNumBlocks());
    ...
    public void testNumBlocksGetterSetter() {
        chunk.setNumBlocks((byte) 5);
        assertEquals(5L, chunk.getNumBlocks());
    }
    ...
    public void testSerializeConsistency() {
        ...
        byte[] serialized1 = chunk.serialize(false);
        byte[] serialized2 = chunk.serialize(false);
    ...
    public void testDeserializeFromNull() {
        Chunk.deserializeFrom(null, false);
    }
    ...
    public void testDeserializeFromEmptyArray() {
        Chunk.deserializeFrom(new byte[0], false);
    }
    ...
    public void testDeserializeFromInvalidLength() {
        ...
        Chunk.deserializeFrom(invalidData, false);
    }
    ...
    public void testWithNegativeNumBlocks() {
        chunk.setNumBlocks((byte) -1);
        assertEquals(-1, chunk.getNumBlocks());
    }
    ...
    public void testDeserializeFromExtraBytes() {
        ...
        Chunk deserialized = Chunk.deserializeFrom(withExtra, false);
    ...
    public void testMultipleSerializeCalls() {
        ...
        byte[] first = chunk.serialize(false);
        byte[] second = chunk.serialize(false);
        byte[] third = chunk.serialize(false);
