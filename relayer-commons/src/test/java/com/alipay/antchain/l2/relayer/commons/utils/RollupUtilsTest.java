...
public class RollupUtilsTest {
    ...
    public void testSerializeChunks_SingleChunk() {
        ...
        byte[] result = RollupUtils.serializeChunks(BatchVersionEnum.BATCH_V1, chunks);
    ...
    public void testAppendToRawChunks_ValidInputs() {
        ...
        byte[] rawChunks = RollupUtils.serializeChunks(BatchVersionEnum.BATCH_V1, Collections.singletonList(chunk1));
        ...
        byte[] newRawChunks = RollupUtils.appendToRawChunks(rawChunks, BatchVersionEnum.BATCH_V1, chunk2);
    ...
    public void testAppendToRawChunks_EmptyInitialArray() {
        ...
        byte[] result = RollupUtils.appendToRawChunks(rawChunks, BatchVersionEnum.BATCH_V1, chunk);
    ...
    public void testDeserializeChunks_ValidData() {
        ...
        byte[] rawChunks = RollupUtils.serializeChunks(BatchVersionEnum.BATCH_V1, originalChunks);

        // Deserialize
        List<Chunk> deserializedChunks = RollupUtils.deserializeChunks(BatchVersionEnum.BATCH_V1, rawChunks);
    ...
    public void testDeserializeChunks_SingleChunk() {
        ...
        byte[] rawChunks = RollupUtils.serializeChunks(BatchVersionEnum.BATCH_V1, Collections.singletonList(chunk));

        List<Chunk> result = RollupUtils.deserializeChunks(BatchVersionEnum.BATCH_V1, rawChunks);
    ...
    public void testSerializeChunks_NullList() {
        RollupUtils.serializeChunks(BatchVersionEnum.BATCH_V1, null);
    }
    ...
    public void testSerializeChunks_ListContainingNull() {
        ...
        RollupUtils.serializeChunks(BatchVersionEnum.BATCH_V1, chunks);
    }
    ...
    public void testAppendToRawChunks_NullRawChunks() {
        ...
        RollupUtils.appendToRawChunks(null, BatchVersionEnum.BATCH_V1, chunk);
    }
    ...
    public void testAppendToRawChunks_NullChunk() {
        ...
        try {
            RollupUtils.appendToRawChunks(rawChunks, BatchVersionEnum.BATCH_V1, null);
    ...
    public void testDeserializeChunks_NullData() {
        RollupUtils.deserializeChunks(BatchVersionEnum.BATCH_V1, null);
    }
    ...
    public void testDeserializeChunks_ZeroLength() {
        ...
        Chunk chunk = createTestChunk(1);
        byte[] validChunk = RollupUtils.serializeChunks(BatchVersionEnum.BATCH_V1, Collections.singletonList(chunk));
    ...
    public void testAppendToRawChunks_MultipleTimes() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            rawChunks = RollupUtils.appendToRawChunks(rawChunks, BatchVersionEnum.BATCH_V1, chunk);
        }
